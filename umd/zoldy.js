(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rakun')) :
  typeof define === 'function' && define.amd ? define(['exports', 'rakun'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Zoldy = {}, global.Rakun));
})(this, (function (exports, rakun) { 'use strict';
  ...
  var zoldyPathParentProvider = rakun.context.create(null);
  var zoldySnapshotProvider = rakun.context.create(null);
  ...
  var emitEvents = function emitEvents(snapshot) {
    ...
    snapshot.setEvents([]);
    return rakun.mono.then();
  };

  var getCacheState = function getCacheState(path, type, snapshot) {
    return rakun.mono.just(snapshot.getState(path, type)).flatPipe(function (state) {
      if (state.state != 'hasValue' && snapshot.parent) {
        return getCacheState(path, type, snapshot.parent);
      }
      return rakun.mono.just(snapshot.getState(path, type));
    });
  };
  ...
  var ZoldySnapshotImpl = /*#__PURE__*/function () {
    function ZoldySnapshotImpl(parent) {
      var _this = this;
      _classCallCheck(this, ZoldySnapshotImpl);
      this.parent = parent;
    ...
    _createClass(ZoldySnapshotImpl, [{
      key: "getEvents",
  ...
  var getSnapshotOrThrow = function getSnapshotOrThrow(ZoldySnapshot) {
    return ZoldySnapshot != null ? rakun.mono.just(ZoldySnapshot) : rakun.mono.error(new Error("NotFound ZoldySnapshot"));
  };
  ...
  var getSnapshot = function getSnapshot() {
    return zoldySnapshotProvider.get().flatPipe(getSnapshotOrThrow);
  };

  var setCacheValue = function setCacheValue(path, type, snapshot, value) {
    return rakun.mono.fromCallback(function () {
  ...
  var get = function get(snapshot, path, _get2, type) {
    return zoldyPathParentProvider.get().flatPipe(function (value) {
      ...
      return rakun.mono.just(value);
    }).flatPipe(function (oldPathParent) {
      return zoldyPathParentProvider.define(path).then(_get2().flatPipe(function (v) {
        return setCacheValue(path, type, snapshot, v).then(zoldyPathParentProvider.define(oldPathParent));
      }));
    }).flatPipe(function () {
  ...
  var reset = function reset(path, type) {
    return function () {
      return getSnapshot().flatPipe(function (ZoldySnapshot) {
        return recursive(ZoldySnapshot, path, type);
      });
    };
  };
    ...
    return function (callback) {
      return getSnapshot().flatPipe(function (snapshot) {
        return rakun.mono.fromCallback(function () {
          ...
          return rakun.mono.just(function () {
  ...
  var ZoldySnapshotManagerImpl = /*#__PURE__*/_createClass(function ZoldySnapshotManagerImpl(path, type) {
    _classCallCheck(this, ZoldySnapshotManagerImpl);
    this.path = path;
    this.type = type;
  ...
  var createSnapshotManager = function createSnapshotManager(path, type) {
    return new ZoldySnapshotManagerImpl(path, type);
  };

  var ZoldyAtomImpl = /*#__PURE__*/function () {
    function ZoldyAtomImpl(config) {
      var _this = this;
      _classCallCheck(this, ZoldyAtomImpl);
  ...
  var ZoldyParamsImpl = /*#__PURE__*/function () {
    function ZoldyParamsImpl(path, fields) {
      _classCallCheck(this, ZoldyParamsImpl);
      this.path = path;
      this.fields = fields;
    }
    _createClass(ZoldyParamsImpl, [{
      key: "encode",
  ...
  var ZoldySelectorStateImpl = /*#__PURE__*/function () {
    function ZoldySelectorStateImpl(config, zoldyValue) {
      _classCallCheck(this, ZoldySelectorStateImpl);
      this.zoldyValue = zoldyValue;
      _defineProperty(this, "_set", void 0);
      this._set = config.set;
    }
    _createClass(ZoldySelectorStateImpl, [{
      key: "path",
      get: function get() {
  ...
  var ZoldySelectorValueImpl = /*#__PURE__*/function () {
    function ZoldySelectorValueImpl(config) {
      var _this = this;
      _classCallCheck(this, ZoldySelectorValueImpl);
    ...
    _createClass(ZoldySelectorValueImpl, [{
      key: "get",
      value: function get() {
        return this.getState().pipe(function (s) {
          return s.value;
  ...
  var ZoldyValue = /*#__PURE__*/_createClass(function ZoldyValue() {
    _classCallCheck(this, ZoldyValue);
    _defineProperty(this, "path", void 0);
  });
  var ZoldyState = /*#__PURE__*/function (_ZoldyValue) {
    ...
    function ZoldyState() {
      _classCallCheck(this, ZoldyState);
      return _super.apply(this, arguments);
    }
    return _createClass(ZoldyState);
  }(ZoldyValue);
