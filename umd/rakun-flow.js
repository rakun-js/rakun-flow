(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.RakunFlow = {}, global.Rakun));
  ...
  var rakunFlowPathParentProvider = rakun.context.create(null);
  var rakunFlowSnapshotProvider = rakun.context.create(null);
  ...
  var getSnapshotOrThrow = function getSnapshotOrThrow(RakunFlowSnapshot) {
    return RakunFlowSnapshot != null ? rakun.mono.just(RakunFlowSnapshot) : rakun.mono.error(new Error("NotFound RakunFlowSnapshot"));
  };
  ...
  exports.RakunFlowState = RakunFlowState;
  exports.RakunFlowValue = RakunFlowValue;
  exports.atom = atom;
  ...
  exports.param = param;
  exports.rakunFlowPathParentProvider = rakunFlowPathParentProvider;
  exports.rakunFlowSnapshotProvider = rakunFlowSnapshotProvider;
